...
export function createUser(user) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userFunctions.findOne(user.email)];
                case 1:
                    existUser = _a.sent();
                    if (existUser) {
                    ...
                    return [4 /*yield*/, userFunctions.insert(user)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    token = jwt.sign({ id: existUser.id }, process.env.SECRET_TOKEN, { expiresIn: '1d' });
